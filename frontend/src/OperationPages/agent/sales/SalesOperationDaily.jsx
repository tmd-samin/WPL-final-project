  ...
  useEffect(() => {
    ...
    fetch(`http://localhost:4000/api/operationSale`, {
      ...
      .then((data) => {
        setSeller(data);
        snackbar(
          data.message ? data.message : "Today's sales have been loaded successfully!"
        );
      });
  }, []);
        ...
        <>
          <div className="titleOperationAndAgents">
            <h3
              style={{
                fontSize: "20px",
              }}>{` Today's customers: ${moment().format("DD/MM/YYYY")}`}</h3>
          </div>
          {
            <TableContainer
              component={Paper}
              ...
              <Table
                ...
                <TableHead>
                  <TableRow>
                    ...
                    <StyledTableCell align="right">                                Aggregate operations
</StyledTableCell>
                    <StyledTableCell align="right">Sales update</StyledTableCell>
                    <StyledTableCell align="right">Deleting a sale</StyledTableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
