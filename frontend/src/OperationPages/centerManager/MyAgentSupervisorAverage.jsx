      ...
      </select>
      {
        <TableContainer component={Paper} id="container">
          <Table sx={{ minWidth: 700 }} aria-label="customized table">
            <TableHead>
              <TableRow>
              <StyledTableCell>Cumulative Number of Calls</StyledTableCell>
              <StyledTableCell align="right">Cumulative Productivity</StyledTableCell>
              <StyledTableCell align="right">Cumulative Disconnection - TV</StyledTableCell>
              <StyledTableCell align="right">Cumulative Disconnection - Fiber</StyledTableCell>
              <StyledTableCell align="right">Cumulative Retention Rate - Fiber</StyledTableCell>
              <StyledTableCell align="right">Cumulative Retention Rate - TV</StyledTableCell>
              <StyledTableCell align="right">Cumulative Sales - Fiber</StyledTableCell>
              <StyledTableCell align="right">Cumulative Sales - TV</StyledTableCell>
              <StyledTableCell align="right">Cumulative EasyMesh</StyledTableCell>
              <StyledTableCell align="right">Cumulative Upgrade</StyledTableCell>
              <StyledTableCell align="right">Cumulative SMT</StyledTableCell>
              <StyledTableCell align="right">Cumulative Sales</StyledTableCell>
              </TableRow>
            </TableHead>
            <TableBody>
